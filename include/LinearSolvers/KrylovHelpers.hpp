...
namespace cuddh
{
    ...
    template <typename real_t>
    inline void rotate_vecs(int n, real_t *d_X, real_t *d_Y, real_t cs, real_t sn)
    {
     ...
     */
    inline void gemm(int m, int n, int k, double alpha, const double *A, int lda, const double *B, int ldb, double beta,
                     double *C, int ldc, bool trans_A = false, bool trans_B = false)
    {
        cblas_dgemm(CblasColMajor, trans_A ? CblasTrans : CblasNoTrans, trans_B ? CblasTrans : CblasNoTrans, m, n, k,
    ...
    {
        cblas_sgemm(CblasColMajor, trans_A ? CblasTrans : CblasNoTrans, trans_B ? CblasTrans : CblasNoTrans, m, n, k,
                    alpha, A, lda, B, ldb, beta, C, ldc);
    }
     ...
     * @param[in] trans_B Whether to transpose matrix B
     */
    inline void gemm_device(cublasHandle_t handle, int m, int n, int k, double alpha, const double *d_A, int lda,
     ...
     * @param[in] trans_B Whether to transpose matrix B
     */
    inline void gemm_device(cublasHandle_t handle, int m, int n, int k, float alpha, const float *d_A, int lda,
