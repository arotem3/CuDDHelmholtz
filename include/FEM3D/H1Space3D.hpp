...
namespace cuddh
{
    ...
    public:
        ...
        const Mesh3D &mesh() const { return _mesh; }
    ...
    public:
        ...
        const_ivec_wrapper faces(MemorySpace m) const { return reshape(_faces.read(m), nf); }
        ...
        const_icube_wrapper subspace_indices(MemorySpace m) const { return reshape(_I.read(m), n_basis, n_basis, nf); }
