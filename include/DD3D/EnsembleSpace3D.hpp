#ifndef CUDDH_ENSEMBLE_SPACE_3D_HPP
#define CUDDH_ENSEMBLE_SPACE_3D_HPP
...
namespace cuddh
{
    ...
    public:
        ...
        {
            return reshape(sp_global.read(m), mx_ndof, n_spaces);
        }
        ...
        {
            return reshape(sp_elems.read(m), mx_elems, n_spaces);
        }
        ...
        {
            return reshape(sp_n_elems.read(m), n_spaces);
        }
        ...
        {
            return reshape(sp_faces.read(m), mx_faces, n_spaces);
        }
        ...
        {
            return reshape(sp_n_faces.read(m), n_spaces);
        }
