...
{
    cuddh_verify(n >= 1, printf("QuadratureRule error: Guass-Legendre rules require n >= 1, but n = %d.", n));
    ...
    static const std::unordered_map<int, std::vector<double>> cached_nodes = {
        ...
        {4,
         {-0.861136311594052575223946, -0.339981043584856264802666, 0.339981043584856264802666,
          0.861136311594052575223946}},
        {5,
         {-0.906179845938663992797627, -0.538469310105683091036314, 0.0, 0.538469310105683091036314,
          0.906179845938663992797627}},
        {6,
         {-0.932469514203152027812302, -0.661209386466264513661400, -0.238619186083196908630502,
          0.238619186083196908630502, 0.661209386466264513661400, 0.932469514203152027812302}},
        {7,
         {-0.949107912342758524526190, -0.741531185599394439863865, -0.405845151377397166906606, 0.0,
          0.405845151377397166906606, 0.741531185599394439863865, 0.949107912342758524526190}},
        {8,
         {-0.960289856497536231683561, -0.796666477413626739591554, -0.525532409916328985817739,
          -0.183434642495649804939476, 0.183434642495649804939476, 0.525532409916328985817739,
          0.796666477413626739591554, 0.960289856497536231683561}},
        {9,
         {-0.968160239507626089835576, -0.836031107326635794299430, -0.613371432700590397308702,
          -0.324253423403808929038538, 0.0, 0.324253423403808929038538, 0.613371432700590397308702,
          0.836031107326635794299430, 0.968160239507626089835576}},
        {10,
         {-0.973906528517171720077964, -0.865063366688984510732097, -0.679409568299024406234327,
          -0.433395394129247190799266, -0.148874338981631210884826, 0.148874338981631210884826,
          0.433395394129247190799266, 0.679409568299024406234327, 0.865063366688984510732097,
    ...
    { // Golub-Welsch algorithm
        ...
        cuddh_verify(info == 0, printf("QuadratureRule error: failed to compute eigenvalues of companion matrix."));
...
{
    cuddh_verify(n >= 2, printf("QuadratureRule error: Gauss-Lobatto rules require n >= 2, but n = %d.", n));
    ...
    static const std::unordered_map<int, std::vector<double>> cached_nodes = {
        ...
        {8,
         {-1, -0.871740148509607, -0.591700181433142, -0.209299217902479, 0.2092992179024789, 0.591700181433142,
          0.871740148509607, 1}},
        {9,
         {-1, -0.899757995411460, -0.677186279510738, -0.363117463826178, 0, 0.363117463826178, 0.677186279510738,
          0.899757995411460, 1}}};
